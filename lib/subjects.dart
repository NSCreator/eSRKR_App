                        ...
                        child: PopupMenuButton(
                          ...
                          itemBuilder: (BuildContext context) =>
                            ...
                            PopupMenuItem(
                              value: "Unit",
                              child: Text(
                                  widget.mode ? "Unit" : "Records & Manuals"),
                            ),
                            if (widget.mode)
                              PopupMenuItem(
                                value: "Text Book",
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (widget
                                    .data.createdByAndPermissions.id.isNotEmpty)
                                  Padding(
              ...
              SliverToBoxAdapter(
                ...
                child: TabBar(
                  ...
                  padding: EdgeInsets.only(top: 20,left: 10,right: 10,bottom: 15),
                    ...
                    tabs: [
                      tabs((widget.mode) ? "Unit" : "Records & Manuals",widget.data.units.length),
                      if(widget.mode)tabs("Model & Previous Papers",widget.data.oldPapers.length),
                      tabs("Description & Questions",widget.data.units.fold(0, (count, element) =>
                      count + (element.Question.isNotEmpty ? element.Question.length : 0))),
                      tabs( "Other Links",widget.data.moreInfos.length),
                    ]),
              ),
            ];
          },
                    ...
                    moreFilter == "all"
                        ...
                        : ListView.builder(
                            ...
                            itemCount: widget.data.moreInfos
                                .where(
                                    (unit) => unit.Type.startsWith(moreFilter))
                                .toList()
                                .length,
                            itemBuilder: (context, int index) {
...
//                                           color: Colors.  black26,
//                                           border:
//                                               Border.all(color: Colors. black10)),
//                                       child: Padding(
//                                         padding: EdgeInsets.symmetric(
//                                             vertical:   2,
//                                             horizontal:   5),
...
//                                             }
//                                           },
//                                       child: Text(a.data,style: TextStyle(color: Colors. black,fontSize: 16),));
//                                     }),
//                                   Container(
//                                     margin: EdgeInsets.symmetric(vertical: 3),
//                                     padding: EdgeInsets.symmetric(vertical: 3,horizontal: 8),
...
//                                             showToastText("Download PDF");
//                                           }
//                                         },child: Text("${index+1}. ${a.data}",style: TextStyle(color: Colors. black,fontSize: 18),));
//                                       }),
//                                   ),
//                                 ],
//                               ),
