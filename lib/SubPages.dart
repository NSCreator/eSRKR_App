...
class subjectsContainer extends StatefulWidget {
  ...
  subjectsContainer(
      {required this.data, required this.branch, required this.isSub});
...
class _subjectsContainerState extends State<subjectsContainer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: widget.data.creator == fullUserId()
      ...
      child: Padding(
        ...
        child: Column(
          children: [
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius:
                            BorderRadius.all(Radius.circular(Size * 20))),
                    child: Center(
                      child: Text(
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (isExp && widget.data.creator.isNotEmpty)
                        Text(
                          "By ${widget.data.creator.split("@").first}",
                          style: TextStyle(
                            fontSize: Size * 12.0,
            ...
            if (isExp)
              Row(
                mainAxisAlignment: widget.data.regulation.isNotEmpty
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      if (widget.isSub &&
                          (widget.data.creator == fullUserId() || isOwner()))
                        PopupMenuButton(
                          icon: Icon(
                            Icons.more_vert,
                            color: Colors.white,
            ...
            child: AnimatedContainer(
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.vertical(
                      top: Radius.circular(widget.size * 25),
                      bottom: Radius.circular(widget.size * 15))),
                  ...
                  child: Column(
                    children: [
                      backButton(
                          ...
                          child: Visibility(
                            visible: widget.creator.split(";").contains(fullUserId()) ||
                                isOwner(),
                            child: PopupMenuButton(
                                    ...
                                    SizedBox(width: widget.size * 70,
                                      child:CarouselSlider(
                                        items: List.generate(
                                          [
                                            "Units",
                                            if (widget.mode == "Subjects")"Text Books",
                                            "More"
                                          ].length,
                                              (int index) {
                                            return Center(
                              ...
                              <PopupMenuEntry>[
                                ...
                                if (widget.mode == "Subjects")PopupMenuItem(
                                  value: "Text Book",
              ...
              children: [
                        ...
                        if (widget.unit.heading.split(";").first != "Unknown")
                          Container(
                            padding: EdgeInsets.symmetric(
                                ...
                                horizontal: widget.size * 5),
                            decoration: BoxDecoration(
                                color: Color(0xFF081214),
                                borderRadius:
                                    BorderRadius.circular(widget.size * 6)),
                            child: Text(
                ...
                InkWell(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(widget.size * 17),
                        color: Colors.white24),
                  ...
                  children: [
                    ...
                    InkWell(
                      child: Container(
                        decoration: BoxDecoration(
                            borderRadius:
                                BorderRadius.circular(widget.size * 17),
                            color: Colors.white70),
                    ...
                    children: [
                      ...
                      if (widget.unit.description.isNotEmpty)
                        ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount:
                                widget.unit.description.split(";").length,
                            itemBuilder: (BuildContext context, int index) {
                              if (widget.unit.description.split(";").length >
                                  0) {
                                return Padding(
                                  padding: EdgeInsets.only(
...
class SyllabusAndModelPapers extends StatefulWidget {
  double size;
  String reg,branch;
   SyllabusAndModelPapers({required this.size,required this.branch,required this.reg});
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Icon(Icons.arrow_back,color: Colors.white,size:widget.size *  20,),
                  ),
                  Container(
                    ...
                    child: Center(
                      child: TabBar(
                        ...
                        isScrollable: true,
                        labelPadding: EdgeInsets.symmetric(horizontal: widget.size * 10),
                        tabs: [
                          Tab(
                            child: Text(
                              "  Syllabus  ",
