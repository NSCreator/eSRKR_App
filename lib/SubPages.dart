                                                                    ...
                                                                    children: [
                                                                      if (file1
                                                                        ...
                                                                        InkWell(
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            await download(Books[index].link,
                                                                                "pdfs");
                                                                            setState(() {
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          try {
                                                                            await FirebaseFirestore.instance.collection('user').doc(fullUserId()).collection("FavouriteBooks").doc(Books[index].id).get().then((docSnapshot) {
                                                                              if (docSnapshot.exists) {
...
class _subjectUnitsDataState extends State<subjectUnitsData> {
  ...
  Stream<List<TextBooksConvertor>> readUnitTextBooks(String subjectsID) =>
      FirebaseFirestore.instance
          .collection('ECE')
          .doc(widget.mode)
          .collection(widget.mode)
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  setState(() {});
                                  showToast("File has been deleted");
                                },
                              ),
                            )
                        ],
