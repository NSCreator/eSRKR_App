                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text("Subjects",style: TextStyle(color: Colors.white,fontSize: 30),),
                          ),
                          StreamBuilder<QuerySnapshot>(
                            stream: FirebaseFirestore.instance.collection('ECE').doc("Subjects").collection("Subjects").snapshots(),
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 10,bottom: 3,top: 5),
                            child: Text("Lab Subjects",style: TextStyle(color: Colors.white,fontSize: 30),),
                          ),
                          StreamBuilder<QuerySnapshot>(
                            stream: FirebaseFirestore.instance.collection('ECE').doc("LabSubjects").collection("LabSubjects").snapshots(),
                            builder: (context, snapshots) {
                              return (snapshots.connectionState == ConnectionState.waiting)
                                  ? Center(
                                child: CircularProgressIndicator(),
