...
class profile extends StatelessWidget {
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: [
          Color.fromRGBO(174, 189, 212, 1),
          Color.fromRGBO(174, 189, 212, 0.3),
          Color.fromRGBO(26, 30, 43, 1),
          Color.fromRGBO(218, 223, 230, 0.5),
          Color.fromRGBO(29, 49, 69, 1),
          Color.fromRGBO(28, 54, 79, 0.5),
  ...
  Widget buildUsers(List<Branch> Branches) => ListView.builder(
          ...
          return Padding(
            ...
            child: InkWell(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          'Total Subjects available : ${branch.subjects}',
                          style: const TextStyle(
                            fontSize: 11.0,
                        ...
                        Text(
                          'Total Lab Subjects available : ${branch.labSubjects}',
                          style: const TextStyle(
                            fontSize: 11.0,
              ...
              onTap: () async {
                ...
                print(branch.sublink);
                print(branch.heading);
...
class yearAndSection extends StatefulWidget {
  const yearAndSection({Key? key}) : super(key: key);

  @override
  State<yearAndSection> createState() => _yearAndSectionState();
}

int branchIndex = 0;

class _yearAndSectionState extends State<yearAndSection> {
  getIntValuesSF() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    int? branchIndexes = prefs.getInt('branchIndex');
    setState(() {
      branchIndex = branchIndexes!;
    });
  }
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: [
          ...
          Color.fromRGBO(174, 189, 212, 0.3),
          Color.fromRGBO(26, 30, 43, 1),
          Color.fromRGBO(218, 223, 230, 0.3),
          Color.fromRGBO(29, 49, 69, 1),
          Color.fromRGBO(28, 54, 79, 0.9),
        ], begin: Alignment.topLeft, end: Alignment.bottomRight),
      ),
      child: Scaffold(
          backgroundColor: Colors.transparent,
  ...
  Widget buildUsers(List<Class> classes) => ListView.builder(
        physics: const BouncingScrollPhysics(),
